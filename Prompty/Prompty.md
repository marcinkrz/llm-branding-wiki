...
## Jak używać
1. Skopiuj [[Prompty/Master prompt strategia|master prompt]] i wstaw nazwę branży/klienta.
2. Agent powinien najpierw przeczytać [[01 Jak myśli strateg marki]] i [[03 Jak korzystać z OS]].
3. Następnie prowadzi przez playbooki ([[Playbooki/00 Jak korzystać z procesu|00–13]]), pytając o brakujące dane.
4. Wynik weryfikuj checklistą [[Checklisty/Checklista jakości strategii|jakości]].
